        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThirdColor = table.Column<string>(nullable: true),
                    FourthColor = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubmissionOpen = table.Column<string>(nullable: true),
                    SubmissionClose = table.Column<string>(nullable: true),
                    Status = table.Column<int>(nullable: false),
                    CourseId = table.Column<Guid>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attachment_Content_ContentId",
                        column: x => x.ContentId,
                        principalTable: "Content",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Attachment_ContentType_TypeId",
                        column: x => x.TypeId,
                        principalTable: "ContentType",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Submission_Content_ContentId",
                        column: x => x.ContentId,
                        principalTable: "Content",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreationDate = table.Column<DateTime>(nullable: false),
                    Excluded = table.Column<bool>(nullable: false),
                    GradeScore = table.Column<decimal>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Grade_Submission_SubmissionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Asset_CourseId",
                table: "Asset",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_Attachment_ContentId",
                table: "Attachment",
                column: "ContentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Grade_SubmissionId",
                table: "Grade",
                column: "SubmissionId");

            migrationBuilder.CreateIndex(
                name: "IX_Submission_ContentId",
                table: "Submission",
                column: "ContentId");
