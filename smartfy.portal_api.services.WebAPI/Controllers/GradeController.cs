...
namespace smartfy.portal_api.services.WebAPI.Controllers
{
    ...
    {
        readonly DbSet<Grade> repository;

        /// <summary>
        /// Construtor
        /// </summary>
        /// <param name="db"></param>
        public GradeController(ApplicationDbContext db) : base(db)
        {
            repository = db.Grades;
        }

        /// <summary>
        /// Returns Grade's List
        /// </summary>
        /// <returns></returns>
        [HttpGet]
        ...
        /// <returns></returns>
        [HttpPost]
        public IActionResult Add([FromBody] Grade vm)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        /// <returns></returns>
        [HttpPut]
        public IActionResult Edit([FromBody] Grade vm)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
